...
import { CHARGE_TYPE_EXPORT_COLUMNS } from '@/helpers/lists/exportColumns';
...
export const useChargeTypeList = () => {
    ...
    const {
        ...
        title: 'Charge Types',
        filenameBase: 'charge-types',
        columns: CHARGE_TYPE_EXPORT_COLUMNS,
        emptyMessage: 'No charge types available to export.',
        getFetchParams: () => ({
            order: multisortConvert(lazyParams.value.multiSortMeta),
            search: search.value,
        }),
