export const KPI_STATS = [
    {
        ...
        detail: 'Approved payments across sale and rent portfolios total $2.45M this quarter.',
        icon: 'pi pi-dollar',
    },
    {
        key: 'properties',
...
export const PAYMENTS = [
    { id: 1, reference: 'PAY-2026-0188', client: 'Zaw Win Htut', invoice: 'INV-2026-0311', amount: 610000, method: 'Bank Transfer', status: 'approved', paid_at: '2026-07-18T15:45:00' },
    { id: 2, reference: 'PAY-2026-0187', client: 'May Thu Zar', invoice: 'INV-2026-0310', amount: 360000, method: 'Mobile Wallet', status: 'pending', paid_at: '2026-07-18T10:20:00' },
    { id: 3, reference: 'PAY-2026-0186', client: 'Su Su Mon', invoice: 'INV-2026-0308', amount: 350000, method: 'Bank Transfer', status: 'approved', paid_at: '2026-07-16T13:30:00' },
    { id: 4, reference: 'PAY-2026-0185', client: 'Mg Mg Aung', invoice: 'INV-2026-0312', amount: 520000, method: 'Cash', status: 'pending', paid_at: '2026-07-19T07:00:00' },
    { id: 5, reference: 'PAY-2026-0184', client: 'Hnin Hnin Wai', invoice: 'INV-2026-0309', amount: 125000, method: 'Bank Transfer', status: 'rejected', paid_at: '2026-07-17T08:15:00' },
];
...
export const STATUS_FILTER_OPTIONS = {
    ...
    payments: ['all', 'pending', 'approved', 'rejected'],
