    ...
    <div class="flex flex-col gap-5">
        <div class="admin-panel relative">
            ...
            >
                <template #header>
                    <AdminListFilters
                        title="All Maintenance Categories"
                        :search="search"
                    ...
                    >
                        <template #actions>
                            <router-link :to="{ name: 'newMaintenanceCategory' }">
                                <Button label="Create" />
                            </router-link>
                            <ListExportActions
                                :loading="isExporting"
                ...
                <template #empty>
                    <AdminEmptyState
                        icon="pi pi-list"
                        title="No maintenance categories found"
                        message="Create a category or adjust your search."
                    />
                </template>
                <template #loading>Loading maintenance categories. Please wait.</template>
                ...
                >
                    <template #body="{ data }">
                        <router-link :to="{ name: 'editMaintenanceCategory', params: { id: data.id } }">
                            <Button
                                icon="pi pi-pencil"
                                text
                                severity="info"
...
import { useMaintenanceCategoryList } from './useMaintenanceCategoryList';
