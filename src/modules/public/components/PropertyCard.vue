<template>
    <article
        class="group h-full overflow-hidden rounded-lg border border-[#d6b8c1]/60 bg-white transition-all duration-300 hover:-translate-y-1 hover:border-[#552032]/35"
    >
        <div class="relative h-64 overflow-hidden md:h-72">
            ...
            <button
                ...
                class="absolute left-4 top-1/2 grid h-10 w-10 -translate-y-1/2 place-items-center rounded-full border border-white/70 bg-white/15 text-white opacity-0 backdrop-blur-sm transition duration-300 hover:bg-white hover:text-[#552032] group-hover:opacity-100"
            >
            ...
            <button
                ...
                class="absolute right-4 top-1/2 grid h-10 w-10 -translate-y-1/2 place-items-center rounded-full border border-white/70 bg-white/15 text-white opacity-0 backdrop-blur-sm transition duration-300 hover:bg-white hover:text-[#552032] group-hover:opacity-100"
            >
            ...
            <div class="absolute bottom-4 left-1/2 flex -translate-x-1/2 gap-2 opacity-0 transition duration-300 group-hover:opacity-100">
                <span class="h-2 w-6 rounded-full bg-white" />
                <span class="h-2 w-2 rounded-full bg-white/60" />
                <span class="h-2 w-2 rounded-full bg-white/60" />
            </div>

            <span
                class="absolute left-4 top-4 rounded-full border border-white/70 bg-white/95 px-3 py-1 text-[0.68rem] font-bold uppercase tracking-[0.16em] text-[#552032] shadow-sm"
            >
                {{ offerLabel }}
            </span>
        </div>
        ...
        <div class="p-5">
            ...
            <div class="property-meta grid grid-cols-2 gap-3 py-4 text-sm text-gray-600">
