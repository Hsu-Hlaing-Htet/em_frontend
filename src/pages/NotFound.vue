<template>
  ...
  >
    <div class="grid justify-content-center p-2 lg:p-0" style="min-width: 80%">
      <div class="col-12 xl:col-6 custom-border">
        <div class="h-full w-full m-0 py-7 px-4 custom-border-content">
          <div class="grid flex flex-column align-items-center">
            ...
            <h1 class="font-bold text-5xl text-900 mb-2">Not Found</h1>
