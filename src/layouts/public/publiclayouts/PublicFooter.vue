...
<template>
  ...
  >
    ...
    <div
      class="absolute bottom-0 left-0
             w-[250px] 
             bg-[#7a3148]/20 rounded-full blur-3xl"
    ></div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14">
        ...
        <div>
          <h2 class="text-3xl font-semibold mb-6">
            Rosewood
            <span class="text-[#d6b8c1]">Royale</span>
          </h2>
  ...
  <div class="flex items-start gap-4">
      ...
      <i class="fas fa-location-dot text-[#d6b8c1] text-lg"></i>


    <div>
      <h4
        class="uppercase tracking-[2px]
               text-sm text-[#d6b8c1] mb-1"
      >
        Office
      </h4>
  ...
  <div class="flex items-start gap-4">
      ...
      <i class="fas fa-phone text-[#d6b8c1] text-lg"></i>
  ...
  <div class="flex items-start gap-4">
      ...
      <i class="fas fa-envelope text-[#d6b8c1] text-lg"></i>
